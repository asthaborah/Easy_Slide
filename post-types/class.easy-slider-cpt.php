...
if (!class_exists('Easy_Slider_Post_Type')) {
    class Easy_Slider_Post_Type
    {
        function __construct()
        {
            ...
            //sorting column
            add_filter( 'manage_edit-easy-slider_sortable_columns', array( $this, 'easy_slider_sortable_columns' ) );
        ...
        public function create_post_type()
        {
            ...
            register_post_type(
                'easy-slider',
                array(
                    'label' => esc_html__('Slider' , 'easy-slider'),
                    'description'   => esc_html__('Sliders' , 'easy-slider'),
                    'labels' => array(
                        'name'  => esc_html__('Sliders' , 'easy-slider'),
                        'singular_name' =>esc_html__('Slider' , 'easy-slider')
                    ),
                    'public'    => true,
        ...
        public function easy_slider_sortable_columns( $columns ){
            $columns['easy_slider_link_text'] = 'easy_slider_link_text';
            return $columns;
        }
        ...
        public function add_meta_boxes()
        {
            add_meta_box(
                ...
                esc_html__('Link Options' , 'easy-slider'),
        ...
        public function save_post($post_id)
        {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'editpost') {
                ...
                if (empty($new_link_text)) {
                    update_post_meta($post_id, 'easy_slider_link_text', esc_html__('Add some text' , 'easy-slider'));
                } else {
